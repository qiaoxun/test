...
public class ProxyServlet extends HttpServlet {
    ...
    private Map<String, String> targetUriMap = new HashMap<>();
    ...
    protected String getTargetUri(HttpServletRequest servletRequest) {
        final String shortUri = servletRequest.getRequestURI();
        StringBuilder shortUriSB = new StringBuilder();
        if (null != targetUriMap) {

            targetUriMap.forEach((key, value) -> {
                if (shortUri.startsWith(key)) {
                    shortUriSB.append(value);
                    return;
                }
            });
        }
        String targetUri = String.valueOf(servletRequest.getAttribute(ATTR_TARGET_URI));
        return targetUri + shortUriSB.toString() ;
    }
    ...
    public void setTargetUriMap(Map<String, String> targetUriMap) {
        this.targetUriMap = targetUriMap;
    }
